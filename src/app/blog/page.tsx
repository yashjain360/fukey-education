  ...
  return (
    <div className="bg-slate-50/50 min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-colors cursor-pointer ${
                  selectedCategory === cat
                    ? "bg-[#050071] text-white shadow-xs"
        ...
        {/* Articles Grid with 100% Real Scraped Cover Images */}
            ...
            >
              <div>
                ...
                <div className="relative aspect-[16/10] bg-slate-100 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-3 py-1 rounded-full bg-black/60 backdrop-blur-md text-white font-extrabold text-[10px] uppercase tracking-wider">
                      {blog.category}
                    </span>
                  </div>
                </div>
              ...
              <div className="px-6 pb-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-full bg-indigo-50 text-[#050071] flex items-center justify-center text-xs font-bold">
                ...
                <Link
                  href={`/blog/${blog.slug}`}
                  className="text-xs font-bold text-[#5751E1] group-hover:text-[#050071] flex items-center gap-1 transition-colors"
                >
