...
export default function WhyChooseUs() {
  ...
  return (
    <section className="py-14 sm:py-20 bg-slate-50/70 border-y border-slate-200/80" data-aos="fade-up">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative" data-aos="fade-right" data-aos-duration="800">
            <div className="relative mx-auto max-w-md rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-gradient-to-tr from-[#050071] via-[#1C1A4A] to-[#5751E1] p-6 sm:p-8 text-white space-y-5 sm:space-y-6">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-amber-400/20 border border-amber-400/30 flex items-center justify-center text-amber-300">
                <Award className="w-8 h-8 sm:w-9 sm:h-9 animate-icon-sparkle" />
              </div>
              ...
              <div className="pt-4 border-t border-white/15 grid grid-cols-2 gap-4 text-xs font-bold">
                <div>
                  <div className="text-xl sm:text-2xl font-black text-amber-300">650+</div>
                  <div className="text-slate-300 text-[10px] sm:text-[11px]">Enrolled Aspirants</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-black text-emerald-300">100%</div>
                  <div className="text-slate-300 text-[10px] sm:text-[11px]">Live Interactivity</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8" data-aos="fade-left" data-aos-duration="850">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {features.map((feat, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-5 sm:p-6 rounded-3xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-all space-y-2.5 sm:space-y-3 group hover:border-indigo-200"
                    data-aos="fade-up"
                    data-aos-delay={idx * 100}
                  >
                    <div className={`w-11 h-11 sm:w-12 sm:h-12 rounded-2xl ${feat.color} flex items-center justify-center shadow-xs transition-transform group-hover:scale-110`}>
                      <Icon className={`w-5 h-5 sm:w-6 sm:h-6 ${feat.anim}`} />
                    </div>
                    <h4 className="text-sm sm:text-base font-black text-slate-900 group-hover:text-[#5751E1] transition-colors">
                      {feat.title}
                    </h4>
